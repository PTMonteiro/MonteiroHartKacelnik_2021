...
soundANDtimeART_SHORT = prefArtificial(prefArtificial(:,4)==1 & prefArtificial(:,2)==1);
soundArt_SHORT = prefArtificial(prefArtificial(:,4)==2 & prefArtificial(:,2)==1);
timeEqualArt_SHORT = prefArtificial(prefArtificial(:,4)==3 & prefArtificial(:,2)==1);
timeDiffArt_SHORT = prefArtificial(prefArtificial(:,4)==4 & prefArtificial(:,2)==1);

soundANDtimeART_LONG = prefArtificial(prefArtificial(:,4)==1 & prefArtificial(:,2)==2);
soundArt_LONG = prefArtificial(prefArtificial(:,4)==2 & prefArtificial(:,2)==2);
timeEqualArt_LONG = prefArtificial(prefArtificial(:,4)==3 & prefArtificial(:,2)==2);
timeDiffArt_LONG = prefArtificial(prefArtificial(:,4)==4 & prefArtificial(:,2)==2);
...
dummy(1:(length(soundANDtimeART_SHORT) + length(soundANDtimeART_LONG)),2) = [soundANDtimeART_SHORT;soundANDtimeART_LONG];
dummy(1:(length(soundNAT_SHORT) + length(soundNAT_LONG)),3) = [soundNAT_SHORT;soundNAT_LONG];
dummy(1:(length(soundArt_SHORT) + length(soundArt_LONG)),4) = [soundArt_SHORT;soundArt_LONG];
dummy(1:(length(timeEqualNAT_SHORT) + length(timeEqualNAT_LONG)),5) = [timeEqualNAT_SHORT;timeEqualNAT_LONG];
dummy(1:(length(timeEqualArt_SHORT) + length(timeEqualArt_LONG)),6) = [timeEqualArt_SHORT;timeEqualArt_LONG];
dummy(1:(length(timeDiffNAT_SHORT) + length(timeDiffNAT_LONG)),7) = [timeDiffNAT_SHORT;timeDiffNAT_LONG];
dummy(1:(length(timeDiffArt_SHORT) + length(timeDiffArt_LONG)),8) = [timeDiffArt_SHORT;timeDiffArt_LONG];

s = rng; % jitter of individual data points
N=20;
a=0.8;
b=1.2;
r = a + (b-a).*rand(N,1);
...
plot(r3(1:numel(soundNAT_LONG)),soundNAT_LONG,'o',...
    'MarkerEdgeColor',colorSOUND,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r5(1:numel(timeEqualNAT_LONG)),timeEqualNAT_LONG,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r7(1:numel(timeDiffNAT_LONG)),timeDiffNAT_LONG,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r2(1:numel(soundANDtimeART_SHORT)),soundANDtimeART_SHORT,'o',...
    'MarkerEdgeColor',colorSOUNDandTIME,...
    'MarkerFaceColor','k',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r4(1:numel(soundArt_SHORT)),soundArt_SHORT,'o',...
    'MarkerEdgeColor',colorSOUND,...
    'MarkerFaceColor','k',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r6(1:numel(timeEqualArt_SHORT)),timeEqualArt_SHORT,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','k',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r8(1:numel(timeDiffArt_SHORT)),timeDiffArt_SHORT,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','k',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r2(1:numel(soundANDtimeART_LONG)),soundANDtimeART_LONG,'o',...
    'MarkerEdgeColor',colorSOUNDandTIME,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1)

plot(r4(1:numel(soundArt_LONG)),soundArt_LONG,'o',...
    'MarkerEdgeColor',colorSOUND,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r6(1:numel(timeEqualArt_LONG)),timeEqualArt_LONG,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')

plot(r8(1:numel(timeDiffArt_LONG)),timeDiffArt_LONG,'o',...
    'MarkerEdgeColor',colorTIME,...
    'MarkerFaceColor','w',...
    'MarkerSize',7,...
    'linewidth', 1,'HandleVisibility','off')
