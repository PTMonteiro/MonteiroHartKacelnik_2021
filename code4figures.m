...
[shortQuack,Fs] = audioread('naturalShort.wav'); % this should be the duck sound short  stimulus
[longQuack,Fs] = audioread('naturalLong.wav'); % this should be the duck sound long stimulus
[shortNoise,Fs] = audioread('artificialShort.wav'); % this should be the white noise burst short stimulus
[longNoise,Fs] = audioread('artificialLong.wav'); % this should be the white noise burst long stimulus
...
% Load data files
prefNatural = readmatrix('preferenceNatural.csv'); % imprinting with duck sound
prefArtificial = readmatrix('preferenceArtificial.csv'); % imprinting with white noise burst
